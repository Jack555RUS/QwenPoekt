...
```json
{
  "file_path": "KNOWLEDGE_BASE/00_CORE/csharp_standards.md"
}
```
...
**Пример вызова:**
```
auto_annotate_file(file_path: "KNOWLEDGE_BASE/00_CORE/csharp_standards.md")
```
...
**Пример вызова:**
```
suggest_related_files(file_path: "KNOWLEDGE_BASE/00_CORE/csharp_standards.md", limit=5)
```
