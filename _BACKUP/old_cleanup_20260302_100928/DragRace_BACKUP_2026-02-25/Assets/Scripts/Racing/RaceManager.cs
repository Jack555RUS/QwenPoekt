...
namespace DragRace.Racing
{
    ...
    public class RaceManager : MonoBehaviour
    {
        ...
        private void CompleteRace()
        {
            ...
            // Расчёт наград
            float earnedMoney = CalculateReward(raceDistance.distanceMeters, isWin);
            float earnedXp = CalculateXp(raceDistance.distanceMeters, isWin);
            ...
            currentRaceResult = new RaceResult
            {
                ...
                earnedXp = earnedXp,
                vehicleId = playerVehicle.vehicleData?.vehicleId
            };
