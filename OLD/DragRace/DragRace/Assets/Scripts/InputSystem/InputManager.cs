...
namespace DragRace.InputSystem
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        [Header("Текущие привязки клавиш")]
        ...
        private void HandleKeyboardInput()
        {
            ...
            // Обработка нажатий (не удержаний)
            ...
            // Отправка события нажатия любой клавиши
            if (Input.anyKeyDown)
            {
        ...
        public void SetKeyBinding(InputAction action, KeyCode key)
        {
            ...
            {
                Debug.LogWarning($"Клавиша {key} уже назначена на другое действие!");
                return;
            }
            ...
            switch (action)
            {
                case InputAction.Accelerate:
                    currentBindings.accelerate = key;
                    break;
                case InputAction.ShiftUp:
                    currentBindings.shiftUp = key;
                    break;
                case InputAction.ShiftDown:
                    currentBindings.shiftDown = key;
                    break;
                case InputAction.Nitro:
                    currentBindings.nitro = key;
                    break;
                case InputAction.Pause:
                    currentBindings.pause = key;
                    break;
            }
